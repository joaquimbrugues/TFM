...
$$E(u) = - \int_{\R} \dd \mathcal{A}_H(u(s)) \cdot \frac{\partial u}{\partial s} \dd s = - \int_{\R} g \left(\grad\mathcal{A}_H(u(s)),\frac{\partial u}{\partial s} \right) \dd s = \int_{\R \times \con{S}^1} \left| \frac{\partial u}{\partial s} \right|^2 \dd t \dd s .$$
