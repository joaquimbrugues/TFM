...
\fancyhead[RO]{The Morse homology is well defined}
 ...
 \chapter{An introduction to symplectic geometry}
\fancyhead[LE]{Symplectic geometry}
In this chapter we are going to present the context in which Floer homology arises, which is the one of symplectic manifolds. We will just comment the highlights of the theory, because we assume that the reader is already familiar with this theory. A good reference to understand symplectic geometry is \cite{da2001lectures}, for instance. At the end of the chapter we are going to focus on the main motivation to develop Floer homology: the Arnold conjecture.

\fancyhead[RO]{Introduction to symplectic manifolds}
