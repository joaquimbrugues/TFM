...
This last remark can be understood as that two diffeomorphic manifolds have the same homology. However, the result much stronger: the homology is invariant in the same homoeomorphism class. This is so because of the following result:

\begin{theo} The Morse homology of a manifold is isomorphic to its cellular homology. In particular, the isomorphism sends each of the critical points to the cell defined by its unstable manifold.
\end{theo}
