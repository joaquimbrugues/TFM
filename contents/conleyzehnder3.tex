...
\begin{lema} \label{looplemma} Consider $\varphi, \psi : [0,T] \rightarrow Sp(\R^{2n},\Omega_0)$ two paths of symplectic matrices with $\varphi(0) = \psi(0) = \Id$. Then, the product path $\psi\varphi$ is homotopic to the path
