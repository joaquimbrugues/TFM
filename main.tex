...
In the 1980s, the construction of Morse homology served as a prototype to define a homology spanned by $1$-periodic Hamiltonian diffeomorphisms on symplectic manifolds. The resulting homology, introduced by Andreas Floer, spectacularly revolutionized the area of symplectic topology and leading to a proof of the famous Arnold conjecture. Floer theory still is the subject of a lot of active and exciting research and is nowadays an essential technique in symplectic topology.

This thesis is twofold: the first part deals with Morse theory and proves the steps towards Morse homology, with examples thoroughly work out to add a comprehensible understanding of the theory. The second part, Chapter 2, 3 and 4, are devoted to outline the fundamental steps in Floer theory by mimicking the construction of the first chapter in the infinite dimensional setting and concluding with the proof of the famous Arnold conjecture.
